      ...
      {loading ? (<Loading />) : (
        <>
          ...
          <VStack spacing={"4"} p={"16"} alignItems={"flex-start"}>
            <Text alignSelf={'center'} fontSize={'small'} opacity={'0.9'}>
            ...
            <Stat>
              ...
              <StatHelpText>
                <StatArrow
                  type={coins.market_data.price_change_percentage_24h > 0 ? "increase" : "decrease"}
                />
                {coins.market_data.price_change_percentage_24h}
              </StatHelpText>
            </Stat>

            <Badge fontSize={'xl'} color={'white'} bg={'blackAlpha.800'}>{`#${coins.market_cap_rank}`}</Badge>
